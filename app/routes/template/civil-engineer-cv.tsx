...
const CivilEngineerCV = () => {
  return (
    <div className="w-[794px] bg-[#c2c2c2] p-[72px]" id="cv-content">
      {/* name */}
      <h1 className="uppercase text-4xl text-[#113f37] font-bold">Tom Munez</h1>
      {/* title/ designation */}
      ...
      <div className="flex flex-col w-full text-lg">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="flex flex-row gap-1 items-center">
            ...
            <Link to={"linkedin.com"} className="text-[#42576a] font-semibold">
              linkedin.com
            </Link>
          </div>
          {/* location */}
      ...
      <div className="grid grid-cols-3 gap-8 mt-8">
        <div className="col-span-2 space-y-6">
          ...
          <div className="">
            ...
            <p className="text-lg text-[#55595f]">
              With over 10 years of experience in civil engineering, I bring a
              deep technical proficiency and a proven track record of managing
              large-scale bridge projects. I am adept at using tools like SAP,
              CSI Bridge, CTBridge, AutoCAD, and MicroStation, and have a strong
              understanding of Caltrans and local agency design standards. One
              of my biggest achievements has been the successful completion of a
              major bridge project that won the 'Best Infrastructure Project'
              award.
            </p>
          </div>
        ...
        <div className="space-y-6">
          <div className="">
            <h3 className="uppercase text-[#113f37] font-bold text-xl">Skills</h3>
            <hr className="h-2 bg-[#113f37] mb-4" />
              ...
              {languageList.map((language, index) => (
                ...
                >
                  ...
                  <div className="flex gap-1 mt-1">
                    {[...Array(5)].map((_, i) => {
                      const isFilled = i < getFilledCircles(language.level as LanguageLevel);
                      return (
                        <div
                          key={i}
